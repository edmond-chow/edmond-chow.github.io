...
consteval bool is_of(std::size_t begin, std::size_t end) noexcept
{
...
private:
	...
	template <std::size_t... I> requires (N == sizeof...(I) && is_of<I...>(0, N))
	...
	template <std::size_t... I> requires (N == sizeof...(I) + 1 && is_of<I...>(0, N))
...
template <std::size_t N, std::size_t... U, std::size_t... V> requires (is_of<U..., V...>(0, N))
